...
summary>span:first-child { color:var(--text); }summary small { font-size:10px; color:var(--text-muted); margin-left:8px; }summary:after { content:'⌄'; color:var(--accent); display:inline-block; transition:transform var(--duration-fast) var(--ease-smooth-out); }.source-panel[open]>summary:after { transform:rotate(180deg); }summary>span:nth-child(2) { margin-left:auto; }summary .warning { color:var(--stale-text); }
