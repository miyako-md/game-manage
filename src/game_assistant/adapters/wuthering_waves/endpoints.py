...
ROLEBOX_ROLE_DETAIL = f"{ROLEBOX_BASE}/getRoleDetail"
ROLEBOX_CHALLENGE_DETAILS = f"{ROLEBOX_BASE}/challengeDetails"
ROLEBOX_SLASH_DETAIL = f"{ROLEBOX_BASE}/slashDetail"
ROLEBOX_MORE_ACTIVITY = f"{ROLEBOX_BASE}/moreActivity"
RESOURCE_BASE = f"{BASE}/aki/resource"
