...
鸣潮支持账号 / 体力 / 版本活动 / 周期进度 / 公告，英雄联盟支持账号 / 战绩 / 公告 / 资讯；
...
（鸣潮 5 个：account / stamina / activity / progress / announcement；英雄联盟 4 个：account / match / announcement / news）。
...
5. 重启后端，在页面点击刷新（或等待轮询），账号/体力/版本活动/周期进度/公告应显示真实数据。
